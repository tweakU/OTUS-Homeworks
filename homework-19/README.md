...
Образ - это шаблон, а контейнер - это экземпляр шаблона, в котором работает приложение.
...
Собрать ядро в контейнере возможно, использовать нет, т.к. контейнер не имеет собственного ядра, а использует ядро хостовой ОС. 
