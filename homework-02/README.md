...
ЗАДАЧА: создать  RAID-массив 10 уровня из четырех дисков. Установим перечень блочных устройств (далее во время паузы вы можете нажать любую клавишу, чтобы продолжить; либо ctrl+C, чтобы прервать выполнение скрипта):
